...
export const caseStudies: CaseStudyProps[] = [
  {
    ...
    testimonial:
      "We went from zero online presence to a professional website and top local ranking in a matter of weeks, thanks to CyberHand. Now, customers find us right away—and our 5-star ratings speak for themselves!",
    imageUrl: "/images/protech-ohio-tran.png",
