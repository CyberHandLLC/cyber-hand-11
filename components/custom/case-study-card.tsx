      ...
      <div className="relative w-full pt-[56.25%]">
        ...
        {caseStudy.imageUrl && (
          <CaseStudyImage
            ...
            placeholderColor={
              caseStudy.industry.includes("Tech")
                ? "#164e63"
                : caseStudy.industry.includes("Health")
                  ? "#166534"
                  : caseStudy.industry.includes("Finance")
                    ? "#1e3a8a"
                    : "#0f172a"
            }
          />
        ...
        {/* Industry badge */}
        <div
          className={`absolute top-4 left-4 ${getThemeStyle("badge", theme)} px-3 py-1 rounded-full text-xs font-semibold`}
        >
          {caseStudy.industry}
        </div>
      </div>
