...
import {
  HeadingSkeleton as _HeadingSkeleton,
  TextSkeleton as _TextSkeleton,
...
export function CaseStudyDetailClient({ caseStudy }: CaseStudyDetailClientProps) {
   ...
   */
  const CaseStudyDetailErrorFallback = ({
    error,
    resetErrorBoundary,
  }: {
    error: Error;
  ...
  return (
    <ErrorBoundary FallbackComponent={CaseStudyDetailErrorFallback}>
      <article className="py-16 md:py-24">
        <CaseStudyHeader caseStudy={caseStudy} theme={currentTheme} />

        <CaseStudyContent caseStudy={caseStudy} theme={currentTheme} router={router} />
      </article>
    </ErrorBoundary>
  );
}
