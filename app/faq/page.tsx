...
export const metadata: Metadata = {
  ...
  description:
    "Find answers to common questions about our digital services, processes, and technologies.",
    ...
    <PageLayout>
      ...
      <SectionContainer className="pt-20 lg:pt-28 text-center">
        ...
        <p className="text-gray-300 max-w-3xl mx-auto text-lg mb-16">
          Find answers to common questions about our services, processes, and technologies. If you
      ...
      <SectionContainer className="pb-20">
        <div className="grid grid-cols-1 gap-12">
          {categories.map((category) => (
            <ContentErrorBoundaryClient key={category}>
