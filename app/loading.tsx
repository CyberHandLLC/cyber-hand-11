    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden cyber-circuit-bg">
      ...
      <div className="relative z-20 px-4 py-16 sm:px-6 lg:px-8 w-full max-w-4xl text-center">
        ...
        <div className="absolute inset-0 z-5 opacity-30 pointer-events-none">
          ...
          <div
            className="absolute h-px w-20 bg-cyan-500/20 animate-pulse"
            style={{ top: "20%", left: "10%", transform: "rotate(45deg)" }}
          ></div>
          <div
            className="absolute h-px w-40 bg-cyan-500/20 animate-pulse"
            style={{ top: "40%", left: "25%", transform: "rotate(45deg)" }}
          ></div>
          <div
            className="absolute h-px w-32 bg-cyan-500/20 animate-pulse"
            style={{ top: "60%", left: "15%", transform: "rotate(45deg)" }}
          ></div>
          <div
            className="absolute h-px w-24 bg-cyan-500/20 animate-pulse"
            style={{ top: "80%", left: "30%", transform: "rotate(45deg)" }}
          ></div>

          {/* Glowing dots using existing Tailwind animations */}
          <div
            className="absolute h-2 w-2 rounded-full bg-cyan-400/30 animate-pulse-glow"
            style={{ top: "30%", right: "20%" }}
          ></div>
          <div
            className="absolute h-2 w-2 rounded-full bg-cyan-400/30 animate-pulse-glow-2"
