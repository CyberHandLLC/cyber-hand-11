...
export function ServicesCTA() {
  ...
  const ctaCardClass =
    theme === "light" ? "bg-white shadow-xl" : "bg-gray-900/50 border border-gray-800";

  return (
    <>
      {/* CTA Section */}
      <div className={`mt-20 text-center p-8 rounded-xl ${ctaCardClass}`}>
        <h2 className={`text-2xl sm:text-3xl font-bold mb-4 ${textClass}`}>
