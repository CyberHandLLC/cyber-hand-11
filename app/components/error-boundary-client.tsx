 ...
 */
export function StandardErrorFallbackClient({ error, resetErrorBoundary }: ErrorFallbackProps) {
  return (
...
export function ContentErrorBoundaryClient({ children }: { children: ReactNode }) {
  return (
    <ReactErrorBoundary
      FallbackComponent={StandardErrorFallbackClient}
      onReset={() => {
...
export function SectionErrorBoundaryClient({ children }: { children: ReactNode }) {
  return (
    <ReactErrorBoundary FallbackComponent={StandardErrorFallbackClient}>{children}</ReactErrorBoundary>
  );
}
